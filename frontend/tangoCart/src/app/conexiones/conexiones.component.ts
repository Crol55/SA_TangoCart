...
export class ConexionesComponent implements OnInit {
  ...
  Grupo1 = {
     ...
     getProducts: "http://34.125.203.249/sa/bus/grupo1/productos", 
  ...
  Grupo2 = {
    ...
    postCompra:   "http://174.138.109.46/api/users/compra", 
  }
  ...
  Grupo3 = {
    ...
    postCompra:   "https://sa-g6.herokuapp.com/api/users/compra",   
  };
  ...
  Grupo4 = {
    ...
    postProducts: "http://35.192.90.40:3000/api/providers/newProduct",
    postCompra:   "http://35.192.90.40:3001/api/users/compra", 
  }
  ...
  Grupo5 = {
    mensaje: "Tienda 5 en linea",
      ...
      postCompra:   "http://35.125.95.83:4000/api/users/compra", 
  };
  ...
  Grupo6 = {
    ...
    postCompra:  "http://sa-g6.herokuapp.com/api/users/compra", 
  }
  Grupo7 = {
    mensaje:   "Tienda 2 en linea",
    registro:     "http://34.71.27.24/api/users/signup",
    login:        "http://34.71.27.24/api/users/signin",
    getProducts:  "http://34.71.27.24/api/providers/allProducts",
    postProducts: "http://34.71.27.24/api/providers/newProduct",
    postCompra:   "http://34.71.27.24/api/users/compra", 
  ...
  Grupo8 = {
    ...
    postCompra:   "http://3.12.103.111:4000/api/users/compra", 
  };
